<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Produtos.aspx.cs"
    Inherits="LojaVirtual.ADMIN.Produtos" %>
...
<body>
    ...
    <asp:GridView ID="grvProdutos" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="grvProdutos_selectedIndexChanged"
