...
namespace DAL
{//numeropatrimonio,patrimonioprov,departamento,sigla,estado,datacadastro,ultimaalteracao
...
"sigla = @sigla, estado = @estado, ultimaalteracao = @ultimaalteracao where codigo = @codigo;";
        ...
        {//---------------------------------------------------------------------------------------------------------------------EXCLUIR
            ...
            cmd.Connection = conexao.ObjetoConexao;
            cmd.CommandText = 
"delete from mesas where codigo = @codigo;";
        ...
        {//---------------------------------------------------------------------------------------------------------------------LOCALIZAR
            ...
            MySqlDataAdapter da = new MySqlDataAdapter(
                "Select * from mesas where numeropatrimonio like '%" + valor + "%'", conexao.StringConexao);
            da.Fill(tabela);
            return tabela;
        }
