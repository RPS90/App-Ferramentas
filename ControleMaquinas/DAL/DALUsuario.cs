...
namespace DAL
{//nomeusuario,login,ramal,departamento,email,foto,DATAC,DATAALT,STATUS
...
"values (@nomeusuario,@login,@ramal,@departamento,@email,@foto,@estado,@datacadastro,@ultimaalteracao); select @@IDENTITY;";
        ...
        {//---------------------------------------------------------------------------------------------------------------------LOCALIZAR
            ...
            MySqlDataAdapter da = new MySqlDataAdapter("select * from usuarios where nomeusuario like '%" + valor + "%'", conexao.StringConexao);
            da.Fill(tabela);
            return tabela;
        }
        ...
        {//---------------------------------------------------------------------------------------------------------------------LOCALIZAR ATIVOS
            DataTable tabela = new DataTable();
            MySqlDataAdapter da = new MySqlDataAdapter("select * from usuarios where nomeusuario like '%" + valor + "%' and usuarios.estado = 'ATIVO'", 
