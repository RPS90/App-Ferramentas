...
{//nomeusuario,login,ramal,departamento,email,foto,estado,datacadastro,ultimaalteracao
    public class ModeloUsuario
    {
        ...
        public ModeloUsuario(int codigo, String nomeusuario, String login, String ramal, 
            int departamento, String email, String foto, String estado, String datacadastro, String ultimaalteracao)
        {
            this.Codigo = codigo;
        ...
        public ModeloUsuario(int codigo, String nomeusuario, String login, String ramal, 
            int departamento, String email, Byte[] foto, String estado, String datacadastro, String ultimaalteracao)
        {
            this.Codigo = codigo;
            this.NomeUsuario = nomeusuario;
            this.Login = login;
