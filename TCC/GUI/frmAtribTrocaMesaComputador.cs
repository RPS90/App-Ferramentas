    ...
    public partial class frmAtribTrocaMesaComputador : Form
    {
        ...
        private void RemoverComputador()
        {
            try
            {
                ...
                if (d.ToString() == "Yes")
                {
                    ...
                    bll2.HistoricoRegistrar("Desvincular Computador", "Alterar", Convert.ToInt32(cbComputador.SelectedValue)); 
                }
            }
            catch { }
        }
        private void CadastrarMesaComputador()
        {
            try
            {
                ...
                BLLHistorico bll2 = new BLLHistorico(cx);
                bll2.HistoricoRegistrar("Atribuir Computador", "Mesa: "+ cbMesa.Text , 1);    
            }
