<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlterarInformacoesClientes.aspx.cs" Inherits="SGVersaoBeta.AlterarInformacoesClientes" %>
...
<body>
    ...
    <center>
        <asp:Label ID="lblRespostaServer" runat="server" Text="" style="font-size: 22px; color: #ff0000; font-weight: bold; text-align: center; margin-top:3%; padding-bottom: 3%; font-family: 'Tahoma';"></asp:Label>
    </center>
    <br /><br />
    <center>
        <!--Início do conteúdo -->
	    <div class="container-formularios" style="height: auto; min-height: 1280px;">
            <h1 class="titulos-paginas-internas"><u>Alterar dados de um cliente</u></h1>
            <div class="clearfix"></div>
             <form id="form1" runat="server">
                 <div class="bloco-grande-form">
				    <span class="nome-input-formularios">Selecione o Cliente: <span style="color: #ff0000;">*</span></span><br>

                     <asp:DropDownList ID="DropDownListTESTE" runat="server" Height="16px" 
                     ViewStateMode="Enabled" EnableViewState="true"
                         onload="DropDownListTESTE_Load" ontextchanged="DropDownListTESTE_TextChanged" 
                         Width="240px">
				...
				<div class="bloco-medio-form">
					<span class="nome-input-formularios">Nome:</span><br>
                    <asp:TextBox ID="txtNomeCliente" runat="server" class="input-formularios" placeholder="Digite o nome do cliente:"></asp:TextBox>
			    </div>
				<div class="bloco-medio-form">
					<span class="nome-input-formularios">Celular: </span><br>
                    <asp:TextBox ID="txtCelular" runat="server" class="input-formularios" placeholder="Informe o número de celular:"></asp:TextBox>
				</div>
                <br/><br/>
                <div class="bloco-medio-form">
                    <span class="nome-input-formularios">CEP:</span><br>
                    <asp:TextBox ID="txtCep" runat="server" class="input-formularios" placeholder="Insira o CEP:"></asp:TextBox>
				</div>
                <div class="bloco-medio-form">
                    <span class="nome-input-formularios">Endereço:</span><br>
                    <asp:TextBox ID="txtLogradouro" runat="server" class="input-formularios" placeholder="Endereço: "></asp:TextBox>
				</div>
				<br/><br/>
                <div class="bloco-medio-form">
                    <span class="nome-input-formularios">Bairro:</span><br>
                    <asp:TextBox ID="txtBairro" runat="server" class="input-formularios" placeholder="Bairro: "></asp:TextBox>
			    </div>
                 <div class="bloco-medio-form">
                    <span class="nome-input-formularios">Cidade:</span><br>
                    <asp:TextBox ID="txtCidade" runat="server" class="input-formularios" placeholder="Cidade: "></asp:TextBox>
				</div>
                <br/><br/>
                <div class="bloco-medio-form">
                    <span class="nome-input-formularios">Estado: </span><br>
                    <asp:TextBox ID="txtUF" runat="server" class="input-formularios" placeholder="UF:"></asp:TextBox>
		        </div>
                <div class="clearfix"></div>
                <br/><br/>
                ...
                <div class="clearfix"></div>
                <div class="bloco-medio-form">
                    <span class="nome-input-formularios">Status do cliente: </span><br>
                    <asp:DropDownList ID="dropStatusCliente" runat="server" class="input-formularios">
