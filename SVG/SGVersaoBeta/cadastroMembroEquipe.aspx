<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastroMembroEquipe.aspx.cs" Inherits="SGVersaoBeta.cadastroMembroEquipe" %>
...
<body>
	...
	<!-- Conteúdo da Home -->
		<center>
            <asp:Label ID="lblrespostaServer" runat="server" Text="" style="color: #ff0000; margin-top: 2%; text-align: center; font-size: 26px; font-weight: bold;"></asp:Label>
            <br /><br />
			<div class="container-formularios">	
				<h1 class="titulos-paginas-internas"><u>Cadastre um novo membro no sistema</u></h1>
				...
				<form id="form1" runat="server" style="padding-bottom: 3%;">
					...
					<div class="bloco-grande-form">
                        ...
                        <asp:TextBox ID="txtNome" runat="server" class="input-formularios" required="required" placeholder="Digite o nome do novo membro:"></asp:TextBox>
					</div>
					<br><br>
					<div class="bloco-medio-form">
						<span class="nome-input-formularios" style="margin-left: 0%;">Setor: <span style="color: #ff0000;">*</span></span><br>
						 <asp:DropDownList ID="dropSetor" runat="server" class="input-formularios" required="required">
					...
					<div class="bloco-medio-form">
                        ...
                        <asp:TextBox ID="txtCargo" runat="server" class="input-formularios" required="required" placeholder="Informe o cargo:"></asp:TextBox>
					</div>
					<br><br>
					<div class="bloco-medio-form">
						<span class="nome-input-formularios" style="margin-left: 0%;">Nível Empresarial: <span style="color: #ff0000;">*</span></span><br>
                        <asp:DropDownList ID="dropNivelEmpresarial" runat="server" class="input-formularios" required="required">
                            <asp:ListItem Value="invalido">Selecione --</asp:ListItem>
					...
					<div class="bloco-medio-form">
                        ...
                        <asp:DropDownList ID="dropExpediente" runat="server" class="input-formularios" required="required">
                            <asp:ListItem Value="invalido">Selecione --</asp:ListItem>
					...
					<div class="bloco-medio-form">
                        ...
                        <asp:TextBox ID="txtEmail" runat="server" class="input-formularios" required="required" placeholder="Digite o e-mail do novo membro:"></asp:TextBox>
					</div>
					<div class="bloco-medio-form">
						<span class="nome-input-formularios">Celular: <span style="color: #ff0000;">*</span></span><br>
                        <asp:TextBox ID="txtCelular" runat="server" class="input-formularios" required="required" placeholder="Digite o número do celular:"></asp:TextBox>
					</div>
					<br><br>
					<div class="bloco-medio-form">
						<span class="nome-input-formularios">Login do usuário: <span style="color: #ff0000;">*</span></span><br>
                        <asp:TextBox ID="txtLogin" runat="server" class="input-formularios" required="required" placeholder="Digite o login que será usado:"></asp:TextBox>
					</div>
					<div class="bloco-medio-form">
						<span class="nome-input-formularios">Senha do usuário: <span style="color: #ff0000;">*</span></span><br>
                        <asp:TextBox ID="txtSenha" type="password" runat="server" class="input-formularios" required="required" placeholder="Digite a senha que será usada:"></asp:TextBox>
					...
					<div class="bloco-medio-form">
                        ...
                        <asp:TextBox ID="txtCep" runat="server" class="input-formularios" required="required" placeholder="Digite o CEP:"></asp:TextBox>
					</div>
					<div class="bloco-medio-form">
						<span class="nome-input-formularios">Endereço: <span style="color: #ff0000;">*</span></span><br>
                        <asp:TextBox ID="txtLogradouro" runat="server" class="input-formularios" required="required" placeholder="Inclua o endereço do novo membro:"></asp:TextBox>
					</div>
					<br><br>
					<div class="bloco-medio-form">
						<span class="nome-input-formularios">Bairro: <span style="color: #ff0000;">*</span></span><br>
                        <asp:TextBox ID="txtBairro" runat="server" class="input-formularios" required="required" placeholder="Digite o nome do bairro:"></asp:TextBox>
					</div>
					<div class="bloco-medio-form">
						<span class="nome-input-formularios">Cidade: <span style="color: #ff0000;">*</span></span><br>
                        <asp:TextBox ID="txtCidade" runat="server" class="input-formularios" required="required" placeholder="Informe o nome da cidade:"></asp:TextBox>
					</div>
					<br><br>
					<div class="bloco-medio-form">
						<span class="nome-input-formularios">Estado: <span style="color: #ff0000;">*</span></span><br>
                        <asp:TextBox ID="txtUF" runat="server" class="input-formularios" required="required" placeholder="Informe o estado:"></asp:TextBox>
					</div>
					<div class="bloco-medio-form">
						<span class="nome-input-formularios">Número: <span style="color: #ff0000;">*</span></span><br>
                        <asp:TextBox ID="txtNumero" runat="server" class="input-formularios" required="required" placeholder="Informe o número da residência:"></asp:TextBox>
					</div>
					<br><br>
