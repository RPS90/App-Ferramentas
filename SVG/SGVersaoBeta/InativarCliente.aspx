<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InativarCliente.aspx.cs" Inherits="SGVersaoBeta.InativarCliente" %>
...
<body>
    ...
    <center>
		<div class="container-formularios">	
		    <h1 class="titulos-paginas-internas"><u>Selecione o cliente que será inativado.</u></h1>
            <form id="form1" runat="server">
            <div class="bloco-grande-form" style="float: none; margin-left: 0%;">
		        <span class="nome-input-formularios">Cliente: <span style="color: #ff0000;">*</span></span><br>
                <asp:DropDownList ID="dropInativarCliente" runat="server" class="input-formularios" required="required"></asp:DropDownList>
                 <br /><br />
			</div>
            <asp:Button ID="btnInativarCliente" runat="server" Text="Inativar" 
                class="botao-form-home" onclick="btnInativarCliente_Click"/>
            </form>
			<div class="clearfix"></div>
            <br /><br />
        </div>
