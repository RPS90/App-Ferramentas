<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="relatorioDePropostas.aspx.cs" Inherits="SistemaFenag.relatorioDePropostas" %>
...
<body>
    ...
    <center>
        <div class="containerPaginas">
            <h1 class="tituloPaginaLogin">Relatório de Propostas</h1>
            <div class="formLogin">
                ...
                <asp:Label ID="lblAgecef" runat="server" Text="Agecef" class="nomesCamposForms"></asp:Label>
                    ...
                    <div class="clearfix"></div><br />
                    <asp:DropDownList ID="dropStatus" runat="server" class="txtLogin" required>
                            <asp:ListItem Value="">Selecione --</asp:ListItem>
                            <asp:ListItem Value="">Aprovada</asp:ListItem>
                            <asp:ListItem Value="">Aprovada com alterações</asp:ListItem>
                            <asp:ListItem Value="">Em análise</asp:ListItem>
                            <asp:ListItem Value="">Recusada</asp:ListItem>
                    </asp:DropDownList>
                    <div class="clearfix"></div>
                    <br />
