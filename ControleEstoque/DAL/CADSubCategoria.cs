...
namespace DAL
{
    public class CADSubCategoria
    {
        private CADConexao conexao;
        public CADSubCategoria(CADConexao cx)//construtor
        {
            this.conexao = cx;
        }
        public void Incluir(ModeloSubCategoria modelo)
        {
            ...
            finally//finally serve pra se der certo ou der merda no try, ele vai executar o finaly e vai desconectar o banco
            { 
                conexao.Desconectar(); 
            }
        ...
        public DataTable Localizar(String valor)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select sc.scat_cod, sc.scat_nome, sc.cat_cod, c.cat_nome "+
                ...
                valor + "%'", conexao.StringConexao);//mostrando com inner join pra pegar o código da categoria tbm
            da.Fill(tabela);
            return tabela;
        }
