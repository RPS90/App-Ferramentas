<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastroAgecef.aspx.cs" Inherits="SistemaFenag.cadastroAgecef" %>
...
<body>
    ...
    <center>
        <div class="containerPaginas">
            <h1 class="tituloPaginaLogin">Cadastro de AGECEF'S</h1>
            <div class="containerFormsPrincipais">
                ...
                <form id="form1" runat="server">
                    ...
                    <div class="clearfix"></div><br /><br />
                    <asp:Button ID="btnCadastrar" runat="server" Text="Cadastrar" class="btnCadastroInterno"/>
                    <div class="clearfix"></div><br /><br />
                </form>
            </div>
        </div>
